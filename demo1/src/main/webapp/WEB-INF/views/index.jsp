...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='assets/vendors/iconly/bold.css'/>">
...
<body>
    ...
    <script src="<c:url value='assets/vendors/apexcharts/apexcharts.js'/>"></script>
    <script src="<c:url value='assets/js/pages/dashboard.js'/>"></script>
