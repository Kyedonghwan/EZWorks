...
<section style="height:64px;padding:0px 24px 16px;">
	<div  style="align:center;width:auto;">
			...
			<nav><br></nav>
			<a href="javascript:openWindowPop('../chat/chat', 'popup');" class="btn btn-outline-warning" style="width:100%;font-size:0.85em;
				javascript:openWindowPop('../chat/chat2', 'popup');" class="btn btn-outline-warning" style="width:100%;font-size:0.85em;">
				채팅
			</a>
