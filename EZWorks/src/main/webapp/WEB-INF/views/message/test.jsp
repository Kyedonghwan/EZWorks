...
<head>
  ...
  <link href="${pageContext.servletContext.contextPath}/resources/css/message/main.css" rel="stylesheet" type="text/css">
  <style>
...
<button id="create-user">Create new user</button>
	<footer id="main_footer">
		<address>Copyright &copy; <a href="#" >김상민</a> All Rights Reserved.</address>
		<address>Blog : <a href="#">https://blog.naver.com/ha98222</a></address>
		<address>Github : <a href="#">https://github.com/eykgond/EZWorks</a></address>
    </footer>
</body>
</html>