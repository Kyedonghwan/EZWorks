			...
			<div class="page-content" style="align-content:stretch;min-height:auto;background:white;border-top:1px solid #dfe3e7;border-collapse: collapse;">
				<section style="padding:0px;margin:0px;height:100%">
					<div style="width: 100%; height: 100%;border: 1px solid black;">
						...
						<!-- íë©´(ë©ë´ë³ ë©ë´ ì¹ì/ì»¨íì¸  ì¹ì) ë¶í êµ¬ê° 
							 ì¬ê¸°ì ê° div ë¹ ì£¼ì´ì§ height:600px ë ììë¡ ì¤ ê°-->
						
						<div style="width: auto%; height: 100%; border-left: 2px solid black;border-right: 5px solid black; margin-left: 250px;border-collapse:collapse;">
