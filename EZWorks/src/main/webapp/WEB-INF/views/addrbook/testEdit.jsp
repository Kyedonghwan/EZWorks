...
<script type="text/javascript">
   ...
   function contactReviseCancel() {
      ...
      // 부서
      $("span#spanDept").show();
      $("input#dept_name").val("${deptName}");
      $("span#dept_name").css("display", "none");
      
      // 직위
      $("span#spanPosition").show();
      $("input#position_name").val("${posName}");
               ...
               <tr>
                  ...
                  <td>
                     <span class="txt_edit" id="mobile" style="display:none">
                        <input id="mobile" name="hp" type="text" value="${vo.hp}" required="required" />
                     </span>
                     <span class="txt_form contact_item_modify" id="spanMobile">${vo.hp}&nbsp;
                        <span class="ui_edit btn_wrap">
               ...
               <tr>
                  ...
                  <td>
                     <span id="officeDetail" class="txt_edit">
                        <c:choose>
                           <c:when test="${empty addrvo.postcode}">
